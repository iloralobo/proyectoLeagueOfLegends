...
public class Partida {
    ...
    public Partida(int id, String codigo, Double server, Map<Jugador, Personaje> elecciones, Map<Integer, Set<Jugador>> jugadoresPorEquipo, LocalDate inicioPartida, LocalDate finPartida, int duracionPartida, Integer equipoVencedor) {
        this.id = id;
        this.codigo = codigo;
        this.server = server;
